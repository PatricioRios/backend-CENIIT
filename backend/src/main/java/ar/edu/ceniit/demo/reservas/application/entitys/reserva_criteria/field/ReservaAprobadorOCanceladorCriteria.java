...
public class ReservaAprobadorOCanceladorCriteria implements ReservaCriteria {
    private final ComparableOperator operator;
    private final Integer usuarioId;

    public ReservaAprobadorOCanceladorCriteria(ComparableOperator operator, Integer usuarioId) {
